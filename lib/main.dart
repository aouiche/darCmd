...
>>>>>>> c36f999c1d71aeef0518024bd1739ed2a96b795c
  runApp(MyApp());
}
...
class _HomeCMDState extends State<HomeCMD> {
  ...
  List<String> namex = ["PUMP", "Water Valves"];
  List<String> ipx = [
    // "192.168.1.109", //F4:CF:A2:F5:B7:09
    // "192.168.1.101", //2C:F4:32:4A:FF:81
    // "192.168.1.102", //DC:4F:22:78:A9:F7
    // "192.168.1.108", //DC:4F:22:78:AA:F8
    "192.168.1.103", //DC:4F:22:78:AD:58
    "192.168.1.107" //F4:CF:A2:F5:B7:09
  ];
