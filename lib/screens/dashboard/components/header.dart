...
import 'package:twiza/searchAll.dart';
      ...
      child: Row(
          ...
          children: <Widget>[
                    ...
                    children: [
                      ...
                      Positioned(
                          ...
                          child: notifNewDonaters != 0
                              ? CircleAvatar(
                                  child: Text(notifNewDonaters.toString(),
                                      style: TextStyle(color: Colors.white)),
                                  backgroundColor: Colors.red)
                              : Container()),
                    ],
            ...
            Container(
              ...
              child: InkWell(
                onTap: () => _search(context, true, false, false),
                child: Icon(
                  Icons.history,
                  size: 30,
                  color: Color(0xFF2697FF),
            ...
            Container(
              ...
              child: InkWell(
                onTap: () => _search(context, false, false, false),
                child: Icon(
                  Icons.search,
                  size: 30,
                  color: Color(0xFF2697FF),
            ...
            //   ),
            //   child: InkWell(
            //       onTap: () => _search(context, false, true, false),
            //       child: Stack(
            //         alignment: AlignmentDirectional.center,
            //         children: [
            //           Icon(
            ...
            //   ),
            //   child: InkWell(
            //       onTap: () => _search(context, false, true, true),
            //       child: Stack(
            //         alignment: AlignmentDirectional.center,
            //         children: [
            //           Icon(
