...
class _LoginUIState extends State<LoginUI> {
 ...
 permissions()async{
   if( await Permission.sms.isGranted && await Permission.phone.isGranted && await Permission.contacts.isGranted){
     setState(() {       
     permission = true;
     });
   }else if( await Permission.sms.request().isGranted && await Permission.phone.request().isGranted &&  await Permission.contacts.request().isGranted){
     setState(() {
     permission = true;       
     });
   }else{
